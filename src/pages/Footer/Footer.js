...
const Footer = () => {
    return (
        <div className='mt-8 font-otherNunito'>
            <footer className="footer footer-center px-10 py-4 bg-primary text-base-content border-base-300">
                ...
                <div>
                    <p>Copyright © 2022 - All right reserved by Jo Chef Ltd</p>
                </div>
            </footer>
        </div>
    );
